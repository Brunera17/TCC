...
class CategoriaServicoRepository:
    ...
    def get_by_id(self, categoria_id: int):
        return CategoriaServico.query.filter_by(id=categoria_id, ativo=True).first()
    ...
    def get_by_nome(self, nome: str):
        return CategoriaServico.query.filter_by(nome=nome, ativo=True).first()
...
class ServicoRepository:
    ...
    def get_by_categoria(self, categoria_id: int):
        return Servico.query.filter_by(categoria_id=categoria_id, ativo=True).all()
    def get_by_id(self, servico_id: int):
        return Servico.query.filter_by(id=servico_id, ativo=True).first()
    def get_by_codigo(self, codigo: str):
        return Servico.query.filter_by(codigo=codigo, ativo=True).first()
    def get_by_nome(self, nome: str):
        return Servico.query.filter_by(nome=nome, ativo=True).first()
