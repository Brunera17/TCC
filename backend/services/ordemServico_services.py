...
class OrdemServicoService:
    ...
    def criar_ordem_servico(self, **data):
        ...
        try:
            ...
            #descricao = (f"Ordem de Serviço, protocolo: {ordem_servico.protocolo}")
            ordem_servico.valor_total_os = total_os
            #gerar_qrcode_pix(ordem_servico.valor_total_os, descricao, ordem_servico.protocolo, "dbrunobruno369@gmail.com")
